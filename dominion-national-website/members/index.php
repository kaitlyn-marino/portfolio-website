...
<body>
  ...
  <main>
    ...
    <section id="about">
      ...
      <h2>We remain committed to delivering innovative benefits and exceptional service to our members. Our website is designed to help you learn more about your benefits and how they help to improve and maintain your overall health.</h2>
    </section>
    ...
    <section id="blocks">
      ...
      <div class="block-two">
        <div class="header">
          ...
          <div class="header-width">
            <h3>KAISER MEMBERS</h3>
          </div>
          <p>Kaiser Foundation Health Plan of the Mid-Atlantic states (Kaiser Permanente). If you have any questions, please contact our Member Services Department.</p>
        </div>

        <div class="button2">
          <div class="button">
            <a href="https://www.dominiondentists.com/kaiser" target="_blank">
              <p>Find a Dentist</p>
            </a>
          </div>
          <div class="button">
            <a href="tel:855.733.7524">
              <p>Call Member Services</p>
            </a>
          </div>
        </div>
      ...
      <div class="block-three">
        <div class="header">
          ...
          <div class="header-width">
            <h3>DOMINION USA, INC.</h3>
          </div>
          <p>Formerly DentaQuest Mid-Atlantic & Virginia Members. If you have any questions, please contact our Member Services Department.</p>
        </div>
          <div class="button2">
            <div class="button">
              <a href="https://www.dominiondentists.com/dominionusa" target="_blank">
                <p>Find a Dentist</p>
              </a>
            </div>
            <div class="button">
              <a href="tel:800.334.6277">
                <p>Call Member Services</p>
              </a>
            </div>
          </div>
      ...
      <div class="block-four">
        <div class="header">
          ...
          <div class="button">
            <a href="https://www.dominionnational.com/wps/wcm/connect/prodnws.dominionnational.com-30097/2b7be7b3-00a8-4722-abb5-1f26af5ebbd5/DN+Complaint+Procedures_10.17.pdf?MOD=AJPERES&CVID=nazKrSJ">
              <p>View Procedures</p>
            </a>
          </div>
        </div>
